...
//#define LAN8720_ENABLE
#define MV88E6061_ENABLE

#ifdef LAN8720_ENABLE
	...
	/* The MV88E6061 PHY status register  */
	#define PHY_SR                 ((uint16_t)17) /* PHY status register Offset */
	#define PHY_SPEED_STATUS       ((uint16_t)0x4000) /* PHY Speed mask */
	#define PHY_DUPLEX_STATUS      ((uint16_t)0x2000) /* PHY Duplex mask */
#endif
